...
public interface SignatureVerifier {
	...
	class SignatureVerification {
		 ...
		 */
		public SignatureVerification(String verifierName, Date creationDate, String signer, String keyFingerprint,
									 String keyUser, boolean verified, boolean expired,
									 @NonNull TrustLevel trustLevel, String message) {
		...
		public @NonNull TrustLevel trustLevel() {
			return trustLevel;
		}
